...
//     if ($feeOption === 'fee-paid') 
//     {
//         $query = "SELECT student_academic.Regno,student_academic.Email, student_academic.current_year, student_academic.type_of_admission,post_grad_payment.1YR_FEE,post_grad_payment.2YR_FEE
...
//     elseif ($feeOption === 'fee-defaulters') 
//     {
//         $query = "SELECT student_academic.Regno, student_academic.current_year, student_academic.batch,post_grad_payment.1YR_FEE,post_grad_payment.2YR_FEE
//         FROM student_academic
//         LEFT JOIN post_grad_payment ON student_academic.Regno = post_grad_payment.REGNO
