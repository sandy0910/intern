...
require("../../FMS1/PHPMailer/src/PHPMailer.php");
require("../../FMS1/PHPMailer/src/SMTP.php");
require ("../../FMS1/PHPMailer/src/Exception.php") ;
...
if(mysqli_num_rows($res) > 0) {
	...
	$mail->isHTML(true);
	$mail->Subject ="Regarding payment of due tution fee";
    $body = '<p>You are hereby reminded to pay the due tution fee for the current academic year on or before '.$dead_line.', failing which fine will be imposed. <br> With Regards :</p>
			   <br>Academic Section,<br>PTU';
	$mail->Body = $body;
