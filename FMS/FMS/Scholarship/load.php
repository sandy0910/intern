...
$_SESSION["pf"] = $pf;
            ...
            $query = "SELECT * FROM student_personal WHERE student_personal.prgm_id LIKE '$pf' AND student_personal.batch LIKE '$bf' ORDER BY Regno;";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td><a href='scholarship.php?Regno=" . $row["Regno"] . "'>" . $row["Regno"] . "</a></td>";
